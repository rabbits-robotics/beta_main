...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PA9     ------> TIM1_CH2
    */
    GPIO_InitStruct.Pin = FIRE_RIGHT_MOTOR_Pin|FIRE_LEFT_MOTOR_Pin;
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PA10     ------> TIM2_CH4
    */
    GPIO_InitStruct.Pin = PITCH_MOTOR_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF10_TIM2;
    HAL_GPIO_Init(PITCH_MOTOR_PWM_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    PA4     ------> TIM3_CH2
    */
    GPIO_InitStruct.Pin = LOAD_MOTOR_ENABLE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
    HAL_GPIO_Init(LOAD_MOTOR_ENABLE_GPIO_Port, &GPIO_InitStruct);
